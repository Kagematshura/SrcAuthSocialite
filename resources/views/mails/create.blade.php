...
<div class="container mx-auto p-8">
    <h1 class="text-4xl font-extrabold mb-8 text-gray-900">Send a Mail</h1>
    ...
    <form action="{{ secure_url('/mails/store') }}" method="POST" class="space-y-4">
        @csrf
        ...
        <div class="form-group">
            <label for="phone" class="block text-sm font-medium text-gray-700">Your Number</label>
        ...
        <div class="form-group">
            ...
            <textarea name="message" id="message" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required></textarea>
        </div>
